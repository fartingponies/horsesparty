    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 GradientFrag (v2f i) : SV_Target
            {
                ...
                fixed4 tileColor = tex2D(_CustomTex, i.uv2 * 1.5);

                finalColor.rgb = lerp(finalColor.rgb, 1 - finalColor.rgb, tileColor.a);
                //finalColor.r = lerp(finalColor.r, 1, tileColor.a);
                //finalColor.gb = lerp(finalColor.gb, 0, tileColor.a);
